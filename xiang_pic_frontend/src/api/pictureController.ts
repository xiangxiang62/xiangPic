...
/** cleanCache GET /api/file/cleanCache */
export async function cleanCacheUsingGet(options?: { [key: string]: any }) {
  return request<API.BaseResponseBoolean_>("/api/file/cleanCache", {
    method: "GET",
    ...(options || {}),
  });
}
...
export async function getPictureOutPaintingTaskUsingGet(
  ...
  return request<API.BaseResponseGetOutPaintingTaskResponse_>(
    "/api/file/out_painting/get_task",
    {
      method: "GET",
      params: {
        ...params,
