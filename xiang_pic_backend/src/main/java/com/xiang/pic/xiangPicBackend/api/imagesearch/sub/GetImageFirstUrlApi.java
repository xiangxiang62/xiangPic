...
public class GetImageFirstUrlApi {
    ...
    public static void main(String[] args) {
        // 请求目标 URL
        String url = "https://graph.baidu.com/s?card_key=&entrance=GENERAL&extUiData[isLogoShow]=1&f=all&isLogoShow=1&session_id=7281246776356490572&sign=121cd8421c9cbc34ed42f01776406842&tpl_from=pc";
